                    ...
                    <div className="bg-[#111827] py-8 px-4 shadow-2xl rounded-2xl sm:px-10 border border-[#1f2937]">
                        ...
                        <div className="relative mt-6 mb-6">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="px-3 bg-[#111827] text-gray-500">{t.orContinueWith}</span>
                            </div>
                        </div>
                        ...
                        <div className="space-y-3">
                            <button
                                type="button"
                                onClick={() => alert(t.oauthPending)}
                                className="w-full flex items-center justify-center gap-3 py-2.5 px-4 border border-[#374151] rounded-lg shadow-sm text-sm font-medium text-gray-300 bg-[#0b0e14] hover:bg-[#1f2937] transition"
                            >
                        ...
                        <div className="mt-6 text-center">
                            <p className="text-sm text-gray-500">
                                {t.noAccountYet}{' '}
                                <Link href="/register" className="font-semibold text-[#8b5cf6] hover:text-[#7c3aed]">
                                    {t.signUp}
                                </Link>
                            </p>
                        </div>
